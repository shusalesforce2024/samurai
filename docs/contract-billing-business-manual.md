...
7. 請求書はFreeeで手動送付する
8. 入金ステータスは毎日2:00にSalesforceへ同期される
...
入金ステータスは、毎日2:00にFreeeからSalesforceへ同期されます。
...
```text
基本通知は行いません。
Freee連携エラー、年契約更新確認、未入金、請求取消などはリストビューまたはレポートで確認します。
```
