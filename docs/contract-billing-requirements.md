...
Salesforce上で、契約・請求・売上予定・入金状況を管理する。
Freeeでは請求書作成・入金ステータス確認を行い、Salesforceへ同期する。
...
基本通知は行わない。
Freee連携エラー、年契約の更新確認対象、未入金、請求取消、Activate見積複数エラーは、リストビューまたはレポートで確認する。
